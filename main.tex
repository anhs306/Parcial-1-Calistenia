...
\begin{enumerate}
    ...
    \item Coloque las tarjetas encima de la hoja o mantengalas en su mano, y vuelva a deslizar la hoja hacia la posición en la que estaba inicialmente.
    ...
    \item Si siente que las tarjetas ya están equilibradas, suelte la mano, si no, puede soltar los dedos pulgar y anular, y moverlas un poco desde arriba con el dedo indice para lograrlo. Por otra parte, si las tarjetas caen, regrese al paso 3 e intentelo de nuevo.
\end{enumerate}
\newpage

\section{Sección de imágenes} \label{imagenes}

\begin{figure}[h]
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth,height=3.5cm]{A}
        \caption{Posición Inicial}
        \label{fig:primera}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth,height=3.5cm]{B}
